...
const customersData = [
  {
    ...
    preferredAgentEmail: 'sarah@connectura.test',
  },
  {
    name: 'Alexis Morgan',
    email: 'alexis@connectura.test',
    ...
    preferredAgentEmail: 'miguel@connectura.test',
  },
]
